...
public class AdminController {
	...
	public ResponseEntity<Students> saveStudents(@RequestBody Students obj) {
		studentservice.saveStudents(obj);
		return new ResponseEntity<Students>(obj, HttpStatus.OK);
	}

	@DeleteMapping("/deletestudents/{id}")
	public String deleteStudents(@PathVariable(value = "id") Integer id) {
